...
file_name = f'losses_rba_fourier_{seed}.txt'
...
class PINN():
    def __init__(self, X_u, u, X_r, lb, ub, dimx, dimt, savept=None):
        ...
        self.first_opt = 300000  # Number of training iterations
    ...
    def net_u(self, x, t):
        # Feed x and t directly into the MLP.
...
if __name__ == "__main__":
    ...
    log_message("Initializing Fourier-feature MLP with RBA-PINN...")
    ...
    model = PINN(X_u, u, X_f, lb, ub, dimx, dimt, savept=f"ac_rba_fourier_model_{seed}")
    ...
    ax[1].set_title('Predicted u(x,t) (RBA-Fourier)', fontsize=14)
    ...
    plt.tight_layout()
    plt.savefig(os.path.join(FIGURE_DIR, f'AC_RBA_Fourier_Prediction_Results_{seed}.png'), dpi=300)
    plt.show()
    ...
    plt.title('Convergence History (RBA-Fourier)', fontsize=14)
    plt.legend(fontsize=12)
    plt.tight_layout()
    plt.savefig(os.path.join(FIGURE_DIR, f'AC_RBA_Fourier_Loss_History_{seed}.png'), dpi=300)
    plt.show()
