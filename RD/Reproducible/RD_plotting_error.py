...
METHODS = {
    'Vanilla PINN': {
        'pattern': 'losses_rd_pinn_{seed}.txt',
        'color': '#7F7F7F',
    },
    'SA-PINN': {
        'pattern': 'losses_rd_sa_{seed}.txt',
        'color': '#74C69D',
    },
    'RBA-PINN': {
        'pattern': 'losses_rd_rba_{seed}.txt',
        'color': '#64B5F6',
    },
    'C-LoReW-PINN': {
        'pattern': 'losses_rd_clorew_pinn_{seed}.txt',
        'color': '#F28482',
    },
}
...
METRICS = {
    'L2RE': {
        'column': 1,
        'output': 'RD_plotting_error_L2RE.png',
        'ylabel': r'Relative $L^2$ error',
    },
    'L_inf': {
        'column': 2,
        'output': 'RD_plotting_error_Linf.png',
