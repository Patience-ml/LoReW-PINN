...
METHODS = [
    {
        'name': 'Vanilla PINN',
        'model_file': f'kg_pinn_model_{SEED}.pt',
    },
    {
        'name': 'SA-PINN',
        'model_file': f'kg_sa_model_{SEED}.pt',
    },
    {
        'name': 'RBA-PINN',
        'model_file': f'kg_rba_model_{SEED}.pt',
    },
    {
        'name': 'C-LoReW-PINN',
        'model_file': f'kg_clorew_pinn_model_{SEED}.pt',
    },
]
...
def main(show=True):
    ...
    output_png = os.path.join(FIGURE_DIR, 'KG_plotting_comparison.png')
    output_pdf = os.path.join(FIGURE_DIR, 'KG_plotting_comparison.pdf')
