...
METHODS = [
    {
        'label': 'PINN',
        'prefix': 'losses_kg_pinn_',
        'color': '#7F7F7F',
        'marker': 'o',
    },
    {
        'label': 'PINN-mMLP',
        'prefix': 'losses_kg_pinn_enhanced_',
        'color': '#4D4D4D',
        'marker': 'o',
    },
    {
        'label': 'SA-PINN',
        'prefix': 'losses_kg_sa_',
        'color': '#74C69D',
        'marker': '^',
    },
    {
        'label': 'SA-mMLP',
        'prefix': 'losses_kg_sa_enhanced_',
        'color': '#2D8F68',
        'marker': '^',
    },
    {
        'label': 'RBA-PINN',
        'prefix': 'losses_kg_rba_',
        'color': '#64B5F6',
        'marker': 'D',
    },
    {
        'label': 'RBA-mMLP',
        'prefix': 'losses_kg_rba_enhanced_',
        'color': '#2E86C1',
        'marker': 'D',
    },
    {
        'label': 'C-LoReW-PINN',
        'prefix': 'losses_kg_clorew_pinn_',
        'color': '#F28482',
        'marker': 's',
    },
    {
        'label': 'C-LoReW-mMLP',
        'prefix': 'losses_kg_clorew_pinn_enhanced_',
        'color': '#C94F4D',
        'marker': 's',
    },
    {
        'label': 'LoReW-PINN',
        'prefix': 'losses_kg_lorew_pinn_',
        'color': '#F28482',
        'marker': 'P',
    },
    {
        'label': 'LoReW-mMLP',
        'prefix': 'losses_kg_lorew_pinn_enhanced_',
        'color': '#C94F4D',
        'marker': 'P',
    },
]
...
def discover_methods_and_seeds(base_dir):
    ...
    if not selected_methods:
        raise FileNotFoundError('No KG loss files were found in the target directory.')

    common_seeds = sorted(common_seeds) if common_seeds is not None else []
    if not common_seeds:
        raise ValueError('No common random seeds were found across the available KG methods.')
...
def plot_comparison(base_dir):
    ...
    fig.suptitle('Klein-Gordon Equation', fontsize=15, y=0.98)
    plt.tight_layout()
    ...
    output_path = os.path.join(figure_dir, 'KG_Method_Comparison_Combined_L2_Linf.png')
