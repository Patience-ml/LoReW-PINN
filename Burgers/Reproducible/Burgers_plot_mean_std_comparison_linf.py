...
SEEDS = [1234, 2138, 2341, 3412, 4123]
NUM_DISPLAY_POINTS = 18

METHODS = {
    'PINN': {
        'pattern': 'losses_burgers_pinn_{seed}.txt',
        'color': '#7F7F7F',
        'marker': 'o',
    },
    'PINN-mMLP': {
        'pattern': 'losses_burgers_pinn_enhanced_{seed}.txt',
        'color': '#4D4D4D',
        'marker': 'o',
    },
    'SA-PINN': {
        'pattern': 'losses_burgers_sa_{seed}.txt',
        'color': '#74C69D',
        'marker': '^',
    },
    'SA-mMLP': {
        'pattern': 'losses_burgers_sa_enhanced_{seed}.txt',
        'color': '#2D8F68',
        'marker': '^',
    },
    'RBA-PINN': {
        'pattern': 'losses_burgers_rba_{seed}.txt',
        'color': '#64B5F6',
        'marker': 'D',
    },
    'RBA-mMLP': {
        'pattern': 'losses_burgers_rba_enhanced_{seed}.txt',
        'color': '#2E86C1',
        'marker': 'D',
    },
    'C-LoReW-PINN': {
        'pattern': 'losses_burgers_clorew_pinn_{seed}.txt',
        'color': '#F28482',
        'marker': 's',
    },
    'C-LoReW-mMLP': {
        'pattern': 'losses_burgers_clorew_pinn_enhanced_{seed}.txt',
        'color': '#C94F4D',
        'marker': 's',
    },
    'LoReW-PINN': {
        'pattern': 'losses_burgers_lorew_pinn_{seed}.txt',
        'color': '#F28482',
        'marker': 'P',
    },
    'LoReW-mMLP': {
        'pattern': 'losses_burgers_lorew_pinn_enhanced_{seed}.txt',
        'color': '#C94F4D',
        'marker': 'P',
    },
}
...
def plot_comparison(base_dir):
    ...
    fig.suptitle('Burgers Equation', fontsize=15, y=0.98)
    plt.tight_layout()
    ...
    output_path = os.path.join(figure_dir, 'Burgers_Method_Comparison_Combined_L2_Linf.png')
