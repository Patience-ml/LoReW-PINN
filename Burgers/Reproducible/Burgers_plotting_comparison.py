...
DATA_PATH = os.path.abspath(os.path.join(FILE_DIR, '..', 'burgers_shock.mat'))
...
METHODS = [
    {
        'name': 'Vanilla PINN',
        'model_file': f'burgers_pinn_model_{SEED}.pt',
    },
    {
        'name': 'SA-PINN',
        'model_file': f'burgers_sa_model_{SEED}.pt',
    },
    {
        'name': 'RBA-PINN',
        'model_file': f'burgers_rba_model_{SEED}.pt',
    },
    {
        'name': 'C-LoReW-PINN',
        'model_file': f'burgers_clorew_pinn_model_{SEED}.pt',
    },
]
...
def load_burgers_data():
    if not os.path.exists(DATA_PATH):
        raise FileNotFoundError(f'Cannot find burgers_shock.mat at {DATA_PATH}')
...
def main(show=True):
    x, t, x_star, exact = load_burgers_data()
    ...
    output_png = os.path.join(FIGURE_DIR, 'Burgers_plotting_comparison.png')
    output_pdf = os.path.join(FIGURE_DIR, 'Burgers_plotting_comparison.pdf')
