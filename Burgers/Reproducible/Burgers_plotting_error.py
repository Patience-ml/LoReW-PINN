...
METRICS = {
    'L2RE': {
        'column': 1,
        'output': 'Burgers_plotting_error_L2RE.png',
        'ylabel': r'Relative $L^2$ error',
    },
    'L_inf': {
        'column': 2,
        'output': 'Burgers_plotting_error_Linf.png',
...
def load_runs(base_dir, pattern, seeds, value_col, epoch_step):
    runs = []
    used_seeds = []
    for seed in seeds:
...
def plot_single_metric(base_dir, metric_name, metric_cfg, seeds, epoch_step, show):
